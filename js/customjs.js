$(document).ready(function() {
    ...
    $("#currencySelect").msDropdown({
        visibleRows: 4
    });
    $("#currencySelect2").msDropdown({
        visibleRows: 4
    });
    ...
    if (seller_id != 0) {
        ...
        $(document).on("click", ".proposal-favorite", function(event) {
            ...
            $.ajax({
                ...
                success: function() {
                    $('i[data-id="' + proposal_id + '"]').attr({
                        class: "proposal-unfavorite fa fa-heart"
                    });
                }
            });
        });
        ...
        $(document).on("click", ".proposal-unfavorite", function(event) {
            ...
            $.ajax({
                ...
                success: function() {
                    $('i[data-id="' + proposal_id + '"]').attr({
                        class: "proposal-favorite fa fa-heart"
                    });
                }
            });
        });
